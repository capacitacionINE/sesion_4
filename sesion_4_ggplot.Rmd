...
**Ejercicio 2**: Construir un gráfico que muestre el ingreso y el gasto p/c promedio, según sexo del jefe de hogar.

**Ejercicio 3**: Construir un gráfico que muestre el ingreso y el gasto p/c promedio, según zona (Metropolitina y resto de capitales regionales).

¿Al terminar las ejercicios, notas algún patrón que se repite?
